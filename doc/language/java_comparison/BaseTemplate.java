...
public class BaseTemplate extends JsonlangObject {
    ...
    public class BaseTemplateSpec extends JsonlangObject {
        public Set<String> nonHiddenFields() {
            Set<String> r = super.nonHiddenFields();
        ...
        public class BaseTemplateSpecSpec extends JsonlangObject {
            public Set<String> nonHiddenFields() {
                Set<String> r = super.nonHiddenFields();
            ...
            public class Container0 extends JsonlangObject {
                public Set<String> nonHiddenFields() {
                    Set<String> r = super.nonHiddenFields();
                ...
                class Env0 extends JsonlangObject {
                    public Set<String> nonHiddenFields() {
                        Set<String> r = super.nonHiddenFields();
