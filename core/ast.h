...
#ifndef JSONLANG_AST_H
#define JSONLANG_AST_H
...
struct Exec : public AST {
    ...
    //{ }
    LiteralString *file;
    Exec(const LocationRange &lr, const Fodder &open_fodder, LiteralString *file)
      : AST(lr, AST_EXEC, open_fodder), file(file)
    { }
};
//// lambda - e
...
struct ObjectField {
    // Depending on the kind of Jsonlang field, the fields of this C++ class are used for storing
