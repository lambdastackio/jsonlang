...
#ifndef JSONLANG_LEXER_H
#define JSONLANG_LEXER_H
...
Tokens jsonlang_lex(const std::string &filename, const char *input);

std::string jsonlang_unlex(const Tokens &tokens);

#endif  // JSONLANG_LEXER_H
